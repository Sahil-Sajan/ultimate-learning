    ...
    <section className="w-full bg-[#f8f9fb] py-12 md:py-20 px-4 md:px-12 lg:px-24 overflow-hidden font-sans">
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
        ...
        <div className="relative h-100 md:h-125 lg:h-150 w-full max-w-125 lg:max-w-none mx-auto order-1 lg:order-2">
          ...
          <div className="absolute bottom-4 left-4 lg:bottom-0 lg:right-10 w-[55%] lg:w-[50%] h-[50%] lg:h-[55%] bg-blue-600 rounded-4xl lg:rounded-[30px] overflow-hidden shadow-2xl z-30 border-4 lg:border-10 border-white">
            <Image
              src="/homecard2.png"
