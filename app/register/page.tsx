        ...
        <div className="max-w-md w-full mx-auto">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="flex items-center gap-2 py-2">
              <input
                type="checkbox"
                className="w-4 h-4 accent-[#ff4667] rounded"
                required
              />
            ...
            <button
              type="submit"
              className="w-full bg-[#ff4667] hover:bg-[#e63e5c] text-white font-bold py-4 rounded-xl transition-all shadow-lg flex items-center justify-center gap-2"
            >
            ...
            <div className="grid grid-cols-2 gap-4">
              <button
                type="button"
                className="flex items-center justify-center gap-2 border border-gray-200 py-3 rounded-xl hover:bg-gray-50 transition-colors text-sm font-medium"
              >
                <img
            ...
            <p className="text-center mt-6 text-sm text-gray-500">
              ...
              <Link href="/login" className="text-[#ff4667] font-bold">
                Sign In
              </Link>
            </p>
          </form>
