    ...
    <div className="min-h-screen bg-[#F8FAFC] font-sans">
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-6 py-10 grid lg:grid-cols-12 gap-8">
        ...
        <main className="lg:col-span-9 space-y-8">
          {/* USER BANNER */}
          <div
            className="relative p-6 md:p-10 overflow-hidden flex flex-col lg:flex-row items-center justify-between text-white shadow-2xl bg-cover bg-center rounded-[32px]"
          ...
          >
            ...
            <div className="flex flex-col md:flex-row items-center gap-6 md:gap-8 relative z-10 text-center md:text-left">
              <div className="relative">
                ...
                <div className="absolute bottom-1 right-1 bg-green-500 border-4 border-white/20 w-6 h-6 md:w-7 md:h-7 rounded-full flex items-center justify-center shadow-lg">
