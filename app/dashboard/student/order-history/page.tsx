      ...
      <div className="max-w-6xl mx-auto space-y-8">
        ...
        <header className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 bg-white p-8 rounded-[32px] border border-slate-200 shadow-sm">
          <div className="flex items-center gap-5">
            <div className="w-16 h-16 bg-[#3B82F6] rounded-2xl flex items-center justify-center text-white font-black text-2xl shadow-lg shadow-blue-200">
              AS
            </div>
            <div>
              ...
              <p className="text-slate-600 font-bold text-xs uppercase tracking-widest mt-0.5">
          ...
          <div className="flex gap-3 w-full md:w-auto">
            ...
            <button className="flex-1 md:flex-none px-6 py-3 bg-[#3B82F6] text-white rounded-xl font-bold text-sm hover:bg-blue-700 transition-all shadow-lg shadow-blue-100">
              Print Report
            </button>
          </div>
        </header>
  ...
  return (
    <div className="space-y-3">
      <div className="flex justify-between items-end">
        ...
        <span className="text-sm font-black text-[#3B82F6]">{score}%</span>
      </div>
...
function TableRow({ name, cat, date, status, score }: any) {
  return (
    <tr className="border-b border-slate-50 hover:bg-slate-50 transition-colors group">
      <td className="py-5">
        <div className="flex items-center gap-3">
          <div className="w-8 h-8 bg-slate-100 rounded-lg flex items-center justify-center group-hover:bg-blue-100 transition-colors">
            <FileText
              size={14}
              className="text-slate-400 group-hover:text-[#3B82F6]"
            />
          </div>
      ...
      <td className="py-5 text-right font-black text-[#3B82F6]">{score}</td>
    </tr>
  );
}
