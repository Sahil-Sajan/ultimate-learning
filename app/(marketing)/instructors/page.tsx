  ...
  const SidebarContent = () => (
    <div className="flex flex-col gap-6">
      <FilterBox title="Categories">
        ...
        <button className="text-[#FF5364] text-sm font-semibold mt-2 text-left hover:underline">
          See More
        </button>
      </FilterBox>
              ...
              <div className="fixed inset-0 z-200 lg:hidden">
                ...
                >
                  <div className="flex items-center justify-between mb-8">
                    <h2 className="text-xl font-bold text-[#1D2026]">
                      Filter Instructors
                    </h2>
                    <button
                      onClick={() => setIsFilterOpen(false)}
                      className="p-2 bg-gray-100 rounded-full text-gray-500 hover:bg-rose-50 hover:text-[#FF5B5C] transition-all"
                    >
                      <X size={20} />
                    </button>
                  </div>
  ...
  return (
    <div className="bg-white border border-gray-100 rounded-xl p-5 shadow-sm">
      ...
      >
        ...
        <ChevronDown
          size={18}
          className={`text-gray-400 transition-transform duration-300 group-hover:text-[#FF5B5C] ${
            isOpen ? "" : "-rotate-90"
          }`}
        />
      </h3>
