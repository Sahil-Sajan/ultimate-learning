...
const MOCK_USERS = [
  { email: "student@gmail.com", password: "123", role: "student", name: "Ali Student" },
  { email: "teacher@gmail.com", password: "123", role: "teacher", name: "Sir Ahmed" },
  { email: "parent@gmail.com",  password: "123", role: "parent",  name: "Mrs. Fatima" },
];
        ...
        <div className="max-w-110 w-full mx-auto -mt-12">
          ...
          <form onSubmit={handleLogin} className="space-y-7">
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              >
                <Image width={20} height={20} src="/googlr-logo.jpg" alt="Google" className="w-5 h-5" />
