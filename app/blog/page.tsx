          ...
          <div className="grid lg:grid-cols-2 gap-0">
            ...
            <div className="p-8 lg:p-12 flex flex-col justify-center">
              ...
              <p className="text-[13px] text-gray-500 leading-relaxed mb-4">
                ...
                our products or services. We believe in fostering long-term
                partnerships by ensuring that our pricing plans.
              </p>
              <p className="text-[13px] text-gray-500 leading-relaxed mb-6">
                Many legal professionals find it difficult to accurately keep
                track of all case-related time, which often results in billable
                time slipping through the tracks and revenue left on the table.
              </p>
